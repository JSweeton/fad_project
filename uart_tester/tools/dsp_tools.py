...
# Author: Corey Bean
#
# Holds a variety of tools needed to process and display discrete audio signals.
# Includes wave creation, filter creation and application, FFT transformations, etc.
#
import math
import numpy as np
...
def plot_from_bytes(bytes):
    ...
    for i in range(len(signals)):
        labels.append(f"Signal {i}")
    plot(signals, labels = labels)
